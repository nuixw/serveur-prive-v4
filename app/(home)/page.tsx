  ...
  return (
    <>
      ...
      <Container> 
            ...
            {games.map((game) => (
              <div key={game.id} className="game-card" data-link aria-label={"Serveurs privés " + game.nom}>
                <div className="game-card-content">
                  ...
                  <Link href={`/jeu`} className="game-card-link">
        ...
        left={
          <>
            <img src="/img/home/home-presentation-characters.webp" alt="Presentation serveur privé" width={861} height={746} loading="lazy" draggable="false" className="home-presentation-left-image" />
            <h2>Une plateforme <strong>innovante</strong> dédiée à la promotion de serveurs de&nbsp;jeux</h2>
            <div className="intro">
              <p>En offrant un référencement gratuit, nous aidons les administrateurs de serveurs à accroître leur visibilité et à se connecter efficacement avec une communauté de joueurs ciblée et enthousiaste.</p>
            </div>
            <div className="paragraph">
              <p>Que votre serveur concerne un jeu spécifique ou plusieurs jeux, notre service assure une visibilité optimale et une croissance rapide de votre base de joueurs.</p>
            </div>
          </>
        } 
        top={
          <>
            ...
            <img src="/img/home/home-presentation-top.webp" alt="Presentation serveur privé" width={619} height={331} loading="lazy" draggable="false" className="presentation-bg" />
          </>
        } 
        bottom={
          <>
            ...
            <div className="intro">
              <p>Serveur Privé est l'endroit idéal pour trouver un serveur adapté à vos besoins, quel que soit votre jeu du moment ou le type de serveur que vous recherchez, il y en a pour tous les goûts.</p>
            </div>
            <div className="paragraph">
              <p>Pour chaque serveur, vous trouverez une description concise accompagnée d'évaluations d'autres joueurs, vous aidant ainsi à choisir un serveur qui répond à vos attentes.</p>
            </div>
            <img src="/img/home/home-presentation-bottom.webp" alt="Presentation serveur privé" width={732} height={523} loading="lazy" draggable="false" className="presentation-bg" />
          </>
        }
      />
      </Container>
